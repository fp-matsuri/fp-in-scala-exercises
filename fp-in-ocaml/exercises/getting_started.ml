...
module Polymorphic_functions = struct
  ...
  let sorted (type a) (_array : a array) (_gt : a -> a -> bool) : bool =
  ...
  let curry (type a b c) (_f : a * b -> c) : a -> b -> c =
    failwith "Not implemented"

  (** Exercise 2.4: [uncurry]を実装せよ。*)
  let uncurry (type a b c) (_f : a -> b -> c) : a * b -> c =
    failwith "Not implemented"

  (** Exercise 2.5: [compose]を実装せよ。*)
  let compose (type a b c) (_f : b -> c) (_g : a -> b) : a -> c =
    failwith "Not implemented"
end
